...
import MonthsCarousel from "@/components/MonthsSlider";
...
export default function Home() {
  ...
  return (
    <main className="pt-12">
      ...
      <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur reprehenderit adipisci nisi earum dignissimos nostrum maxime, provident dolores voluptatem ea blanditiis accusamus perferendis, tempore ab alias, accusantium modi! Delectus, officiis.</p>
