...
export default function OutboundGroup() {
  ...
  return (
    <main>
      <GroupDown title="Categorias de Despesas">
        <form className="flex flex-row gap-2 items-end justify-between border-t border-gray-200 pt-2" onSubmit={handleSubmitForm}>
          <Input name="name" placeholder="Ex.: Alimentação, Transporte" value={form.name} onChange={handleChangeInput} />
