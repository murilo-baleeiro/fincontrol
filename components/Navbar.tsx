  ...
  if (pathname !== "/auth") {
    return (
      <nav className="fixed bottom-0 left-0 right-0 h-16 flex justify-around items-center bg-white z-0">
        ...
        <Link
          href="/monthly"
          className={`flex-1 flex flex-col justify-center items-center border-t border-gray-200 py-2 ${pathname == "/monthly" && "text-blue-600 font-semibold border-t-blue-600"}`}
        >
