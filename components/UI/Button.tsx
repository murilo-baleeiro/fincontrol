...
export default function Button({ variant = "primary", className, ...props }: ButtonProps) {
  const defaultClass = twMerge("w-full px-4 py-2 border border-blue-500 rounded-md font-medium focus:outline-none focus:ring-2 focus:ring-offset-2", className);
